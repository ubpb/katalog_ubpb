  ...
  def create
    ...
    if response_code == "erfolg"
      ...
      @error_message = case response_code
        ...
        when "fehler_jahrgang_band"     then "Fehler: Bitte geben Sie den Jahrgang und Nummer des Bandes an."
        when "fehler_jahr_in_ebene"     then @volume_error = true ; "Fehler: Sie haben einen Jahrgang ab 1996 eingegeben! Diese Zeitschriftenbände finden Sie in der Regel in den Fachbibliotheken (auf Ebene 4 und der Eingangsebene ab 1996). Wenn Sie sicher sind, dass sich der von Ihnen benötigte Band im Magazin befindet, schalten Sie bitte im Eingabeformular die Jahrgangsprüfung aus."
        when "fehler_jahrgang_falsch"   then "Fehler: Sie haben den Zeitschriftenjahrgang nicht richtig eingegeben! Bitte geben Sie das Jahr vierstellig ein. Bitte beachten Sie dabei: Im Magazin sind nur Jahrgänge bis 1995. Neuere Zeitschriftenbände finden Sie in den Fachbibliotheken."
